    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex">
            ...
            <div class="logo mr-auto" style="">
                {{-- <h1 class="text-light"><a href="index.html"><span>T</span>rillion</a></h1> --}}
                <a href="/"><img src="{{ asset('assets/img/logo.png') }}" alt="logo.png"
                        style="width: 250px; height: 83px; margin: -19px; max-height: 100px;" class=""></a>
            </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="well-middle">
                            ...
                            <div class="single-well">
                                ...
                                <p style="font-size:18px;text-align: justify;font-family:times new roman;">
                                    As a leading System Integrator, Trillion Device builds world-class IT solutions
                                    that
                                    fit the unique requirements of our customers. Representing the most OEM’s in the
                                    industry, Trillion Device rides on the cutting edge of the technology wave and
                                    has
                                    specialization in providing managed IT services to small, medium enterprises
                                    including BFSI, IT/ITES, Government, PSU’s and many more
                                </p>
